...
module.exports = HandleMsg = async (urbae, message) => {
	try {
      ...
      if (chats == 'Permisi'){
          urbae.sendPtt(from, './media/ohayou.mp3', id)
      }
      if (chats == 'permisi'){
          urbae.sendPtt(from, './media/ohayou.mp3', id)
      }
     ...
     if (chats == '#rhentai'){
      ...
      if (chats == 'Gajelas'){
          urbae.sendPtt(from, './media/bakaa.mp33', id)
      }
      if (chats == 'Bg'){
          urbae.sendPtt(from, './media/ohayou.mp3', id)
      }
			...
			break
				...
				case prefix + 'kisahnabi':
					...
					axios.get(`https://cakrayp.herokuapp.com/api/islamic/prophet/story?nabi=${dudo2}&apikey=${cakrayp}`)
						.then(async (res) => {
							const textnab = `Nama : *${res.data.result.nama}*\nLahir : *${res.data.result.kelahirahir}*\Wafat Usia : *${res.data.result.wafat_usia}*\nTempat : *${res.data.result.singgah}*\n\nKisah : ${res.data.result.kisah}`
