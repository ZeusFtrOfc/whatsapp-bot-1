...
const errorurl = 'https://ibb.co/RHxcNw9'
const errorurl2 = 'https://ibb.co/RHxcNw9'
	...
	try {
     ...
     if (chats == '#rhentai'){
      ...
      if (chats == 'hai'){
		...
		const menupict = "https://ibb.co/RHxcNw9"
 ...
 break
				...
				case prefix + 'stickernobg':
					if (isMedia || isImage || isQuotedImage) {
						...
						urbae.sendImageAsSticker(from, heynobg, { author: '@thoriqazzikraa', pack: 'ZeusXz', removebg: true })
							.catch((err) => {
								console.log(err)
								urbae.reply(from, err.message, id)
							})
				...
				case prefix + 'asupan7':
					...
					break
				case prefix + 'asupan6':
					urbae.reply(from, 'Error ngab!' id)
				...
				case prefix + 'wallprogramming':
					urbae.reply(from, mess.wait, id)
					axios.get(`https://urbaee-xyz.herokuapp.com/api/wallpaper/programming?apikey=ZeusXz`)
						.then(async (res) => {
				...
				case prefix + 'ayatkursi':
					urbae.reply(from, mess.wait, id)
					axios.get(`https://urbaee-xyz.herokuapp.com/api/muslim/ayatkursi?apikey=ZeusXz`)
						.then(async (res) => {
