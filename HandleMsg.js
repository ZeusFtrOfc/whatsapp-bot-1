...
case prefix + 'yuri':
					try {
						urbae.reply(from, mess.wait, id)
						axios.get('https://zenzapi.xyz/api/anime/nsfw/yuri?apikey=${zenzapi}', { responseType: 'arrayBuffer' }).then(res => {
							urbae.sendFileFromUrl(from, res.data, 'yuri.jpeg', 'Sange kok sama gambar:v');
...
case prefix + 'bjgif':
					try {
						...
						axios.get('https://zenzapi.xyz/api/anime/nsfw/bj?apikey=${zenzapi}', { responseType: 'arrayBuffer' }).then(res => {
							urbae.sendFileFromUrl(from, res.data, 'bj.gif', 'Sange kok sama gambar:v');
				...
				case prefix + 'aesthetic':
					...
					axios.get(`https://api.zeks.me/api/estetikpic?apikey=${apikeyvinz}`)
						.then(async (res) => {
							await urbae.sendFileFromUrl(from, res.data, 'img.jpg', 'nihh pict estetiknya', id)
								.catch(() => {
									urbae.reply(from, 'Error', id)
								})
						})
...
case prefix + 'translate2':
 ...
 break
				...
				case prefix + 'memes':
					urbae.reply(from, mess.wait, id)
					urbae.sendFileFromUrl(from, `https://cakrayp.herokuapp.com/api/random/meme?apikey=${cakrayp}`, 'img.jpg', '', id)
						.then(async (res) => {
							const kndm = res.data.result.url
							
							urbae.sendFileFromUrl(from, kndm, 'img.jpg', 'Aowkakakakaiwkw', id)
								.catch(() => {
									urbae.reply(from, 'Error', id)
								})
						})
