...
const help = (prefix, jame, betime, blockNumber, prem, banned, cts, waver, limit) => {
    return `
*┏━──Information Bot*
*┃*
*┃➥ Bot Name : ZeusXz Bot*
*┃➥ Whatsapp Bot Version : 2.8.2*
*┃➥ Creator : ZeusXz*
*┃➥Limit Anda : ${limit}*
*┃➥ Date : ${betime}*
*┃➥ Time : ${jame}*
...
_Terimakasih Telah Menggunakan Bot ZeusXz Store, Jangan Lupa Share Bot Ini Supaya Banyak Yang Menikmati Fitur ZeusXz Bot._
`
}
exports.help = help
